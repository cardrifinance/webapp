...
import { createAirtimePayment, createChinaPayment } from "@/services/bank";
...
import { getPurpose, getRate, getTransactions } from "@/services/lib";
import {
  Select,
  SelectItem,
  SelectValue,
...
const AirtimePage = () => {
    ...
    const sendRequest = async () => {
      ...
      try {
        if (otp && otp.length === 4 && watch("amount") && watch("number")) {
          ...
          const response = await createAirtimePayment(payload);
          //@ts-ignore
          if (response.success === "false") {
            ...
            //@ts-ignore
            toast.success(response.Message || "Airtime purchased");
            setstep(2);
            ...
            <div className="flex w-full flex-col gap-4 justify-center items-center">
              <div className="w-full text-center">
                ...
                <span className="text-[14px] font-normal font-inter text-center  text-[#464646] leading-[28px] mt-2 inline-block">
                  Top up airtime on your most preferred network.
                </span>
              </div>
            </div>
              ...
              >
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex gap-3 items-center">
                    {allRecentBeneficiaries?.map((ben, index) => (
                      <div
                      ...
                      >
                        <div
                          className={cn(
                            ...
                            index === 0 ? "bg-primary-100" : "bg-[#C90C451A]"
                          )}
                        >
  ...
  return (
    ...
    >
      ...
      <NetWorkModal paymentList={TypeList} />
