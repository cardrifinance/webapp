              ...
              >
                <div className='flex items-center gap-4'>
                  ...
                  <span className='text-base text-[#07052A] font-inter font-normal'>
                    9 Payment Service Bank <br /> (9PSB)
                  </span>
                </div>
                <span className='text-[#1FBA79] font-inter font-normal text-sm'>
                  Free funding
                </span>
                <div className='absolute right-0  p-2 flex items-center text-[#474256] gap-2 bg-[#FEF4EA] rounded-tr-xl rounded-br-xl rounded-bl-xl top-20 text-[8px] font-inter'>
                  <Warning2 size={12} color='#FA9232' />
                  Currently experiencing slow funding, fund may take some time
                  to reflect.
                </div>
              </div>

              <div
                className='p-4 mt-7 border border-[#FAF7FF] rounded-2xl  flex items-center justify-between  cursor-pointer'
                onClick={() => handleBankDetails(2)}
              >
                <div className='flex items-center gap-4'>
                  <Image
                    src={bankLogo2}
                ...
                <span className='text-[#B4ACCA] font-inter font-normal text-sm'>
                  0.5% funding fee
                </span>
              </div>
            </div>
